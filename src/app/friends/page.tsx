...
import { Loader2, RefreshCcw, UserMinus, UserPlus, UserX, Users } from 'lucide-react';
        ...
        <main className="flex-1">
          <section className="mx-auto flex w-full max-w-7xl flex-col gap-8 px-4 py-10 sm:px-6 lg:px-8">
            <div className="space-y-3">
              ...
              <h2 className="font-display font-semibold text-3xl text-zen-900">Invite the partners who keep you grounded.</h2>
            ...
            >
              <div className="flex-1">
                ...
                <input
                  ...
                  className="mt-2 w-full rounded-xl border border-zen-200 bg-surface px-4 py-3 text-sm text-zen-900 shadow-inner focus:border-sage-400 focus:outline-none focus:ring-2 focus:ring-sage-200"
                  autoComplete="email"
                  required
                />
              </div>
              ...
              <div className="mt-6 space-y-4">
                {isLoading ? (
                  ...
                  friends.map(friend => (
                    <div
                      key={friend.id}
                      className="flex flex-col gap-3 rounded-xl border border-zen-100 bg-surface px-4 py-4 shadow-inner sm:flex-row sm:items-center sm:justify-between"
                    >
                      <div>
                ...
                <div className="mt-6 space-y-4">
                  {outgoingRequests.length === 0 ? (
                    ...
                    outgoingRequests.map(request => (
                      <div
                        key={request.id}
                        className="flex flex-col gap-3 rounded-xl border border-zen-100 bg-surface px-4 py-4 shadow-inner"
                      >
                        <div>
                          <p className="text-sm font-semibold text-zen-900">
