        ...
        <div className="relative flex min-h-screen flex-col">
          <header className="px-4 py-6 sm:px-6 lg:px-8">
            <div className="mx-auto flex max-w-7xl flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="font-display font-semibold text-2xl text-zen-900">Zen Workspace</h1>
          ...
          <main className="flex flex-1 flex-col items-center justify-center gap-12 px-4 pb-12 sm:px-6 lg:flex-row lg:px-8">
            <div className="max-w-xl space-y-4 text-center lg:text-left">
              <h2 className="font-display font-semibold text-3xl text-zen-900">Sign in to unlock Zen Insights</h2>
